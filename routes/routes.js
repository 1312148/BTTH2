module.exports = function(app){
	...
	app.get('/home', function(req, res) {		
		AM.getUserRecords(email, function(e,o){
	...
	app.get('/listfriend',function(req,res){
		AM.getAllRecords( function(e, accounts){
			res.render('listfriend', { title : 'Friend List', accts : accounts });
		});
	});

	app.post('/listfriend', function(req,res){
		AM.addNewFriend({friend : req.body['friendlist']}, function(e){
			if (e){
				res.status(400).send(e);
			}	else{				
